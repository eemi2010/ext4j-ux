package com.ait.ext4j.ux.notification.client;
...
class NotificationContainer extends Panel {
    ...
    private native NotificationContainer init()/*-{
		...
		@com.ait.ext4j.ux.notification.client.NotificationContainer::configPrototype = c.initialConfig;
    }-*/;
    ...
    private static native JavaScriptObject _createPeer(NotificationConfig config) /*-{
		var c = config.@com.ait.ext4j.client.core.JsObject::getJsObj()();
    ...
    native void slideBack() /*-{
		var notification = this.@com.ait.ext4j.client.core.Component::getOrCreateJsObj()();
