package com.ati.ext4j.ux.notification.client;
...
class NotificationContainer extends Panel {
    ...
    private native NotificationContainer init()/*-{
		...
		@com.ati.ext4j.ux.notification.client.NotificationContainer::configPrototype = c.initialConfig;
    }-*/;
    ...
    private static native JavaScriptObject _createPeer(NotificationConfig config) /*-{
		var c = config.@com.ati.ext4j.client.core.JsObject::getJsObj()();
    ...
    native void slideBack() /*-{
		var notification = this.@com.ati.ext4j.client.core.Component::getOrCreateJsObj()();
